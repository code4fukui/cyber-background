...
class Main {
  ...
  private static CANVAS_WIDTH:number = 960 * 2;
  private static CANVAS_HEIGHT:number = 540 * 2 * 1.5;
  //private static CANVAS_HEIGHT:number = 540 * 2;
  ...
  constructor()
  {
    ...
    */
    //
    this.camera = new Camera(30 * Main.RAD, Main.CANVAS_WIDTH / Main.CANVAS_HEIGHT, 0.1, 1000.0);
  ...
  private render():void
  {
    ...
    const x = 0; //this.mouseX;
    const y = 0; // this.mouseY
    this.transformFeedbackShader.getUniform("mouse").vector4 = vec4.fromValues(1 / (40.0 + x * 20.0), 1 / (1.0 + y * 20.0), 0, 0);
